...
def ensure_indexes() -> None:
    ...
    get_collection("payment_sessions").create_index("txn_ref", unique=True)
    get_collection("payment_sessions").create_index("status")
    get_collection("payment_sessions").create_index("created_at")
